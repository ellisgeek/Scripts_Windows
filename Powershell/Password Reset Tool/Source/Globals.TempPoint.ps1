...
Import-Module MsDtc
$passwordLength = 8
$logFile = "\\ltc-cleveland\sys2\NetworkScriptLogs\PWResetsWithGUI\StudentPwResetsFromGUI.csv"
$networkSvcsEmail = "LTCNetworkAdministrators@gotoltc.edu"
...
<br /><br />
If you did not request a password change, contact Computer Services at (920) 482-7706 (ext. 1710 on campus) immediately.
</p>
"@
                }
                Unlock {
...
"@
    ...
    Write-Host("$subject")
    Send-MailMessage -SmtpServer "ltc-apps2.ltc-nt.com" -From $from -To $to -Subject $subject -Body $body -BodyAsHtml
}
